...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.namrField = QtWidgets.QLineEdit(parent=Form)
        self.namrField.setObjectName("namrField")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.namrField)
    ...
    def retranslateUi(self, Form):
        ...
        self.gender.setItemText(0, _translate("Form", "женский"))
        self.gender.setItemText(1, _translate("Form", "мужской"))
